...
ax.plot(rad_microns, measurement0, label = 'no correction', color = 'red')
ax.plot(rad_microns, measurement01, label = '0.1 spherical correction', color = 'orange')
ax.plot(rad_microns, measurement025, label = '0.25 spherical correction', color = 'green')
