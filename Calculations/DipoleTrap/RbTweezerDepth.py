...
import numpy as np
from scipy.constants import c, epsilon_0, elementary_charge, electron_mass, Boltzmann
...
print("Dipole potential is: "+ str(potential_depth_mK)+ " mK deep")
